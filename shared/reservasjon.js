...
function normalizeKlokkeslett(value) {
...
function formatTilbudGyldigTilTekst(datoIso, klokkeslett) {
...
function buildBilSummaryRows(bil, bilKmTekst) {
...
module.exports = {
  ...
  addDaysIso,
  formatNorskDato,
  normalizeKlokkeslett,
  formatTilbudGyldigTilTekst,
  formatNok,
